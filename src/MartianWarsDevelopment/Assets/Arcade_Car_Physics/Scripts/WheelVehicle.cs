...
namespace VehicleBehaviour
{
  ...
  public class WheelVehicle : MonoBehaviour
  {
    ...
    // Max steering angle, usually higher for drift car
    ...
    // How height do you want to jump?
    ...
    void FixedUpdate()
    {
      ...
      if (_isPlayer)
      {
        ...
        // Turn
        steering = _turnInputCurve.Evaluate(GetInput(turnInput)) * steerAngle;
        // Drift
